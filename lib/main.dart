...
class _TabsState extends State<Tabs> {
  ...
  final List<Widget> _screens = [
    ...
    AddListMobX(title: 'Add List MobX')
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      items: [
        ...
        BottomNavigationBarItem(icon: Icon(Icons.stream), title: Text('Dynamic-List-RxDart')),
        BottomNavigationBarItem(icon: Icon(Icons.stream), title: Text('Dynamic-List-Provider')),
        BottomNavigationBarItem(icon: Icon(Icons.stream), title: Text('Dynamic-List-MobX')),
      ],
    ));
  }
}
